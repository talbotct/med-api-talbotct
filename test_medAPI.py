...
class TestmedAPI(unittest.TestCase):
    ...
    def test_patientPost(self):
        ...
        medAPI.post("http://127.0.0.1:5000/patients?patientID=11111&name=Timmy Test&hospital=TestHospital&temperature=11&systolicBP=111&diastolicBP=11&pulse=111&oximeter=11&weight=111&glucometer=11")
        response = medAPI.get("http://127.0.0.1:5000/patients?patientID=12340")
